    ...
    run_demo({
        ...
        -- Formatting Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 1/8 (Press <ESC> to stop demo)",
                    "",
                    "## Formatting",
                    "Set formatting:",
                    "- Emphasis",
        ...
        -- Inline Link Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 2/8 (Press <ESC> to stop demo)",
                    "",
                    "## Inline links",
        ...
        -- WikiLink Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 3/8 (Press <ESC> to stop demo)",
                    "",
                    "## WikiLinks",
                    "- Create WikiLink",
                    "- Follow WikiLink",
        ...
        -- Reference Link Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 5/8 (Press <ESC> to stop demo)",
                    "",
                    "## Reference links",
                    "- Open [link.md][]",
                    "- Delete [link.md][]",
        ...
        -- Footnotes Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 6/8 (Press <ESC> to stop demo)",
                    "",
                    "## Footnotes",
                    "- Insert  ",
                    "- Update [^5]",
        ...
        -- ToC Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 7/8 (Press <ESC> to stop demo)",
                    "",
                    "## Table of Contents",
                    "- Create and update",
                    "",
        ...
        -- Outliner Demo Start
        {
            action = function()
                vim.api.nvim_buf_set_lines(demo_buf, 0, -1, false, {
                    "# Mdnotes Demo",
                    "Progress: 8/8 (Press <ESC> to stop demo)",
                    "",
                    "## Outliner",
                    "- Item",
                    "- Item",
        ...
        {
            action = function()
                vim.api.nvim_feedkeys(":Mdn outliner indent\n", "n", false)
            end,
            delay = 1000,
        },
        {
        ...
        {
            action = function()
                vim.api.nvim_feedkeys(":Mdn outliner unindent\n", "n", false)
            end,
            delay = 1000,
        },
        -- Outliner Demo End
